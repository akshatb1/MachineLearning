...
for i=1:200
    ...
    feature1{i+200}=-1*[1 (train_pattern_3{i})]'; % Normalization
end
%initialize a
a=(1/2)*ones(121,1);
for p=1:50
...
for i=1:100
    ...
    feature2{i+100}=-1*[1 (test_pattern_3{i})]';
end
accuracy1=0;
for i=1:100
    if a'*feature2{i}>= 0
...
disp('Accuracy for class-1 for classification b/w class 1 and 3 is :')
accuracy1
accuracy2=0;
for i=1:100
...
disp('Accuracy for class-3 for classification b/w class 1 and 3 is :')
accuracy2